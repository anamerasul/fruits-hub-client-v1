      ...
      <section className="text-gray-400 bg-gray-900 body-font relative">
        ...
        <div className="container px-5 py-24 mx-auto  flex">
          <div className="lg:w-1/3 md:w-1/2 bg-yellow-200 shadow-md rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">
            ...
            <button className="text-gray-800 transition duration-300 bg-orange-600 border-0 py-2 px-6 focus:outline-none hover:bg-orange-800 rounded text-lg">
              SEND
            </button>
          </div>
        </div>
...
export default FruitsHubLocation;
